       ...
       // orasRestaurant = "Ploiesti";
        ...
        for(int i=0; i < restaurantSelected.getMeniu().size();i++)
        {
           ...
           // Image image = new Image("ApplicationUI/Images/Screenshot_4.png");
            ...
            tempItemName.setLayoutY(34 + windowDown);
            ...
            tempIngredientNume.setLayoutY(65 + windowDown);
            ...
            tempProdusApp.setLayoutY(39 + windowDown);
            ...
            tempOrder.setLayoutY(37 + windowDown);
            ...
            tempNrproduse.setLayoutY(48 + windowDown);
            menuPanel.getChildren().add(tempNrproduse);



            windowDown = windowDown + 112;
